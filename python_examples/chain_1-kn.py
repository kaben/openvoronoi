...
if __name__ == "__main__":  
    ...
    p6=ovd.Point(-0.05,-0.1)
    p7=ovd.Point(0.1,0.05)
    p8=ovd.Point(0.15,0.09)
    p9=ovd.Point(0.3,0.3)
    p10=ovd.Point(-0.3,0.15)
    ...
    id6=vd.addVertexSite(p6)
    id7=vd.addVertexSite(p7)
    id8=vd.addVertexSite(p8)
    id9=vd.addVertexSite(p9)
    id10=vd.addVertexSite(p10)
    ...
    vd.addLineSite(id10, id9)
    vd.addLineSite(id9, id8)
    vd.addLineSite(id8, id7)
    vd.addLineSite(id7, id6)
    vd.addLineSite(id6, id10)
